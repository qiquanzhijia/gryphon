...
ext_modules = [
    ...
    Extension('gryphon.lib.models.datum', ['gryphon/lib/models/datum.pyx']),
    ...
    Extension('gryphon.libc.adjustment', ['gryphon/libc/adjustment.pyx']),
    Extension('gryphon.libc._factorize', ['gryphon/libc/_factorize.pyx']),
